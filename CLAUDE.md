...
- **Two pinned Godot binaries, both in `tools/`.** Use them, not a system-wide
  ...
  `C:/temp/godotsetup/engine/godot/` (standard) for tests and everyday work; `C:/temp/godotsetup/engine/godot-mono/`
...
- **Run the tests before saying anything works:**
  `C:\temp\godotsetup\engine\godot\Godot_v4.7.2-stable_win64_console.exe --headless --path game res://tests/test_runner.tscn`
